            ...
            if (result.success) {
                ...
                if (userRole === 'owner') {
                    ...
                    if (documentStatus === 'pending' || documentStatus === 'not_submitted') {
                        ...
                        console.log('Navigating owner to owner/owner-home (pending)');
                        router.replace('/owner/owner-home');
                    } else if (documentStatus === 'approved') {
                        // Approved owner - can access full owner features
                        console.log('Navigating owner to owner/owner-home (approved)');
                        router.replace('/owner/owner-home');
                    } else if (documentStatus === 'rejected') {
                        // Rejected owner - may need to resubmit documents
                        console.log('Navigating owner to owner/owner-home (rejected)');
                        router.replace('/owner/owner-home');
                    } else {
                        // Default case for owner
                        console.log('Navigating owner to owner/owner-home (default)');
                        router.replace('/owner/owner-home');
                    }
                } else if (userRole === 'trainer') {
                    // Trainers go to their respective home screen
                    console.log('Navigating trainer to trainer/trainer-home');
                    router.replace('/trainer/trainer-home');
                } else {
                    // Members and other roles go to regular user home
                    console.log('Navigating member to member/user-home');
                    router.replace('/member/user-home');
                }
            } else {
